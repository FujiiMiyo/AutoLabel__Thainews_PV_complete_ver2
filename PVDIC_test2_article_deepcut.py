# -*- coding: utf-8 -*-
"""
Created on Wed Jun  3 13:33:59 2020
...
class doc_labeling(object):
    ...
    def doc_to_vec(self,documents):
        ...
        %time model.save('model_deepcut_test2')  #*** 14,880 articles
...
if __name__ == '__main__':
    ...
    print(all_list_vec)
    with open('json_all_list_vec_deepcut_test2.txt','w', encoding='utf-8') as f:

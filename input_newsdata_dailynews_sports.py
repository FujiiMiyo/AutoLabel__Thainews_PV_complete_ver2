...
cnt = 0
sql = cur.execute("SELECT URL FROM dailynews_url_sports") #***edit categories: economic, education, entertainment, foreign, it, sports
url = cur.fetchall()
...
if __name__ == '__main__':
    for i in url:
        getLinks(i[0],"sports","dailynews") #***edit categories: economic, education, entertainment, foreign, it, sports

# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 01:58:46 2020
...
class doc_labeling(object):
    ...
    def doc_to_vec(self,documents):
        ...
        %time model.save('model_attacut_test1') #*** 14,880 articles
...
if __name__ == '__main__':
    ...
    print(all_list_vec)
    with open('json_all_list_vec_attacut_test1.txt','w', encoding='utf-8') as f:

...
if __name__ == '__main__':
    ...
    target_doc = 'it_715' #taraget paragraph
    dtarget_doc_vector = model_loaded_deepcut.docvecs[target_doc]
    atarget_doc_vector = model_loaded_attacut.docvecs[target_doc]
    ddoc_sim_word = list(model_loaded_deepcut.wv.similar_by_vector(dtarget_doc_vector, topn=7, restrict_vocab=None))
    adoc_sim_word = list(model_loaded_attacut.wv.similar_by_vector(atarget_doc_vector, topn=7, restrict_vocab=None))
    ...
    dfeat_vec = dtarget_doc_vector + ddoc_sim_doc_vector[0]
    ...
    dfeat_words_arr = ['Feature vector'] #**
    ...
    afeat_words_arr = ['Feature vector'] #**
    ...
    for i, word in enumerate(dwords_arr):
        if i != 0:
            ax1.plot(dresult_X_simword[i, 0], dresult_X_simword[i, 1], 'o', color='gold')###
    ...
    crimson_patch = mpatches.Patch(color='crimson', label='Target Word vector')
    gold_patch = mpatches.Patch(color='gold', label='Similar Word vector')
    ax1.legend(handles=[crimson_patch , gold_patch], loc='upper right')
    plt.grid(True)
    plt.show()
    ...
    for i, word in enumerate(awords_arr):
        if i != 0:
            ay1.plot(aresult_X_simword[i, 0], aresult_X_simword[i, 1], 'o', color='gold')###
    ...
    crimson_patch = mpatches.Patch(color='crimson', label='Target Word vector')
    gold_patch = mpatches.Patch(color='gold', label='Similar Word vector')
    ay1.legend(handles=[crimson_patch , gold_patch], loc='upper right')
    plt.grid(True)
    plt.show()
    ...
    for i, word in enumerate(ddoc_words_arr):
        if i != 0:
            ax2.plot(dresult_X_doc_simword[i, 0], dresult_X_doc_simword[i, 1], 'o', color='gold')###
    ...
    gold_patch = mpatches.Patch(color='gold', label='Similar Word vector')
    ax2.legend(handles=[crimson_patch , gold_patch], loc='upper right')
    plt.grid(True)
    plt.show()
    ...
    for i, word in enumerate(adoc_words_arr):
        if i != 0:
            ay2.plot(aresult_X_doc_simword[i, 0], aresult_X_doc_simword[i, 1], 'o', color='gold')###
    ...
    crimson_patch = mpatches.Patch(color='crimson', label='Target Paragraph vector')
    gold_patch = mpatches.Patch(color='gold', label='Similar Word vector')
    ay2.legend(handles=[crimson_patch , gold_patch], loc='upper right')
    plt.grid(True)
    plt.show()'''
    ...
    for i, word in enumerate(dfeat_words_arr):
        if i != 0:
            ...
            ax2.plot(dresult_X_feat_simword[0, 0], dresult_X_feat_simword[0, 1], '^', color='hotpink')###

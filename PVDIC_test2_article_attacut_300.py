# -*- coding: utf-8 -*-
"""
Created on Thu Jun 11 15:16:42 2020
...
class doc_labeling(object):
    ...
    def doc_to_vec(self,documents):
        ...
        %time model.save('model_attacut_test2_it_300')  #*** 300 articles


if __name__ == '__main__':
        
    doclb = doc_labeling()
    e = doclb.get_body_it(300) #*** 300 articles
    ...
    print(all_list_vec)
    with open('json_all_list_vec_attacut_test2_it_300.txt','w', encoding='utf-8') as f:

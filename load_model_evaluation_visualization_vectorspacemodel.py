    ...
    def plot_list_dvec(self,all_list_doc_id,list_dwords_sim_id,dresult_X_all,p,limit_docs):
        for i, word in enumerate(list_dwords_sim_id):
            if i < p:
                ...
                scatter6 = ax0.scatter(dresult_X_all[i, 0], dresult_X_all[i, 1], c='#94ebd8', label=list_genre_plot[0], alpha=0.5, edgecolors='none', marker='>', s=80)
                #plt.annotate(doc, xy=(dresult_X_all[j, 0], dresult_X_all[j, 1]))
            elif i >= p and i < (p*2):
                #word_edu = word
                #print("Deepcut Education word: ", word_edu)
                scatter7 = ax0.scatter(dresult_X_all[i, 0], dresult_X_all[i, 1], c='#fff8cd', label=list_genre_plot[1], alpha=1.0, edgecolors='none', marker='>', s=80)
            elif i >= (p*2) and i < (p*3):
                #word_ent = word
                #print("Deepcut Entertainment word: ", word_ent)
                scatter8 = ax0.scatter(dresult_X_all[i, 0], dresult_X_all[i, 1], c='#ffd5cd', label=list_genre_plot[2], alpha=0.6, edgecolors='none', marker='>', s=80)
            elif i >= (p*3) and i < (p*4):
                #word_fore = word
                #print("Deepcut Foreign word: ", word_fore)
                scatter9 = ax0.scatter(dresult_X_all[i, 0], dresult_X_all[i, 1], c='#d88081', label=list_genre_plot[3], alpha=0.5, edgecolors='none', marker='>', s=80)
            elif i >= (p*4) and i < (p*5):
                #word_it = word
                #print("Deepcut IT word: ", word_it)
                scatter10 = ax0.scatter(dresult_X_all[i, 0], dresult_X_all[i, 1], c='#f3bad6', label=list_genre_plot[4], alpha=0.5, edgecolors='none', marker='>', s=80)
            elif i >= (p*5) and i < (p*6):
                #word_spo = word
                #print("Deepcut Sports word: ", word_spo)
                scatter11 = ax0.scatter(dresult_X_all[i, 0], dresult_X_all[i, 1], c='#9885b2', label=list_genre_plot[5], alpha=0.5, edgecolors='none', marker='>', s=80)
                #j = j + 1 
        ...
        for j, doc in enumerate(all_list_doc_id):
            if j < limit_docs:
                ...
                scatter0 = ax0.scatter(dresult_X_all[j, 0], dresult_X_all[j, 1], c='#00787a', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)  
                ...
                scatter1 = ax0.scatter(dresult_X_all[j, 0], dresult_X_all[j, 1], c='#fbc11a', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)
            elif j >= limit_docs*2 and j < limit_docs*3:
                #doc_ent = doc
                #print("Deepcut Entertainment: ", doc_ent)
                scatter2 = ax0.scatter(dresult_X_all[j, 0], dresult_X_all[j, 1], c='#ff6334', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)
            elif j >= limit_docs*3 and j < limit_docs*4:
                #doc_fore = doc
                #print("Deepcut Foreign: ", doc_fore)
                scatter3 = ax0.scatter(dresult_X_all[j, 0], dresult_X_all[j, 1], c='#981826', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)
            elif j >= limit_docs*4 and j < limit_docs*5:
                #doc_it = doc
                #print("Deepcut IT: ", doc_it)
                scatter4 = ax0.scatter(dresult_X_all[j, 0], dresult_X_all[j, 1], c='#cc0e74', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)
            elif j >= limit_docs*5 and j < limit_docs*6:
                #doc_spo = doc
                #print("Deepcut Sports: ", doc_spo)
                scatter5 = ax0.scatter(dresult_X_all[j, 0], dresult_X_all[j, 1], c='#821752', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)
                #j = j + 1
    ...
    def plot_list_avec(self,all_list_doc_id,list_awords_sim_id,aresult_X_all,p,limit_docs):
        for i, word in enumerate(list_awords_sim_id):
            if i < p:
                #word_eco = word
                #print("Deepcut Economic word: ", word_eco)
                scatter6 = ay0.scatter(aresult_X_all[i, 0], aresult_X_all[i, 1], c='#94ebd8', label=list_genre_plot[0], alpha=0.5, edgecolors='none', marker='>', s=80)
                #plt.annotate(doc, xy=(aresult_X_all[j, 0], aresult_X_all[j, 1]))
            elif i >= p and i < (p*2):
                #word_edu = word
                #print("Deepcut Education word: ", word_edu)
                scatter7 = ay0.scatter(aresult_X_all[i, 0], aresult_X_all[i, 1], c='#fff8cd', label=list_genre_plot[1], alpha=1.0, edgecolors='none', marker='>', s=80)
            elif i >= (p*2) and i < (p*3):
                #word_ent = word
                #print("Deepcut Entertainment word: ", word_ent)
                scatter8 = ay0.scatter(aresult_X_all[i, 0], aresult_X_all[i, 1], c='#ffd5cd', label=list_genre_plot[2], alpha=0.6, edgecolors='none', marker='>', s=80)
            elif i >= (p*3) and i < (p*4):
                #word_fore = word
                #print("Deepcut Foreign word: ", word_fore)
                scatter9 = ay0.scatter(aresult_X_all[i, 0], aresult_X_all[i, 1], c='#d88081', label=list_genre_plot[3], alpha=0.5, edgecolors='none', marker='>', s=80)
            elif i >= (p*4) and i < (p*5):
                #word_it = word
                #print("Deepcut IT word: ", word_it)
                scatter10 = ay0.scatter(aresult_X_all[i, 0], aresult_X_all[i, 1], c='#f3bad6', label=list_genre_plot[4], alpha=0.5, edgecolors='none', marker='>', s=80)
            elif i >= (p*5) and i < (p*6):
                #word_spo = word
                #print("Deepcut Sports word: ", word_spo)
                scatter11 = ay0.scatter(aresult_X_all[i, 0], aresult_X_all[i, 1], c='#9885b2', label=list_genre_plot[5], alpha=0.5, edgecolors='none', marker='>', s=80)
                #j = j + 1 
        ...
        for j, doc in enumerate(all_list_doc_id):
            if j < limit_docs:
                #doc_eco = doc
                #print("Deepcut Economic: ", doc_eco)
                scatter0 = ay0.scatter(aresult_X_all[j, 0], aresult_X_all[j, 1], c='#00787a', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)  
                #plt.annotate(doc, xy=(aresult_X_all[j, 0], aresult_X_all[j, 1]))
            elif j >= limit_docs and j < limit_docs*2:
                #doc_edu = doc
                #print("Deepcut Education: ", doc_edu)
                scatter1 = ay0.scatter(aresult_X_all[j, 0], aresult_X_all[j, 1], c='#fbc11a', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)
            elif j >= limit_docs*2 and j < limit_docs*3:
                #doc_ent = doc
                #print("Deepcut Entertainment: ", doc_ent)
                scatter2 = ay0.scatter(aresult_X_all[j, 0], aresult_X_all[j, 1], c='#ff6334', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)
            elif j >= limit_docs*3 and j < limit_docs*4:
                #doc_fore = doc
                #print("Deepcut Foreign: ", doc_fore)
                scatter3 = ay0.scatter(aresult_X_all[j, 0], aresult_X_all[j, 1], c='#981826', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)
            elif j >= limit_docs*4 and j < limit_docs*5:
                #doc_it = doc
                #print("Deepcut IT: ", doc_it)
                scatter4 = ay0.scatter(aresult_X_all[j, 0], aresult_X_all[j, 1], c='#cc0e74', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)
            elif j >= limit_docs*5 and j < limit_docs*6:
                #doc_spo = doc
                #print("Deepcut Sports: ", doc_spo)
                scatter5 = ay0.scatter(aresult_X_all[j, 0], aresult_X_all[j, 1], c='#821752', label=list_genre_plot[0], alpha=0.8, edgecolors='none', marker='o', s=110)
                #j = j + 1
        return scatter0,scatter1,scatter2,scatter3,scatter4,scatter5,scatter6,scatter7,scatter8,scatter9,scatter10,scatter11
...
if __name__ == '__main__':
    ...
    m = 10 ##Note: Count Similar paragraph(s)
    o = 50 ##Note: Count Similar words -> plot
    ...
    ################################################################################
    fig, ay0 = plt.subplots()
    ay0.set_yticklabels([]) #Hide ticks
    ay0.set_xticklabels([]) #Hide ticks
    ay0.set_title('[2D] Vector Space Model - DOC2VEC with Attacut (n_words = ' + str(n*count_gerne) + ' , limit_docs = ' + str(limit_docs*count_gerne) + ')')

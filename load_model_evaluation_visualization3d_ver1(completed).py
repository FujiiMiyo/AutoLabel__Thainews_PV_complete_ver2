...
class visaulization_vector_space_model(object):        
    ...
    def plot_list_dsimwords_tword(self,list_dword_id,dresult_X,o):
        for i, word in enumerate(list_dword_id):
            if i != 0:
                if i < o:
                    scatter0 = ax1.scatter3D(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], c='#007d92', alpha=0.8, edgecolors='none', marker='>', depthshade=False, s=80)###
                    ax1.text(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], word)
                    #print("Similar words = ",word)
                else:
                    scatter1 = ax1.scatter3D(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], c='#fdd03b', alpha=0.5, edgecolors='none', marker='>', depthshade=False, s=80)###
                    #ax1.text(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], word)
                    #print("Similar words = ",word)        
            else:
                scatter2 = ax1.scatter3D(dresult_X[0, 0], dresult_X[0, 1], dresult_X[0, 2], c='#981826', alpha=0.8, edgecolors='none', marker=(5,1), depthshade=False, s=110)###
                ax1.text(dresult_X[0, 0], dresult_X[0, 1], dresult_X[0, 2], word)
    ...
    def plot_list_asimwords_tword(self,list_aword_id,aresult_X,o):
        for i, word in enumerate(list_aword_id):
            if i != 0:
                if i < o:
                    scatter0 = ay1.scatter3D(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], c='#007d92', alpha=0.8, edgecolors='none', marker='>', depthshade=False, s=80)###
                    ay1.text(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], word)
                    #print("Similar words = ",word)
                else:
                    scatter1 = ay1.scatter3D(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], c='#fdd03b', alpha=0.5, edgecolors='none', marker='>', depthshade=False, s=80)###
                    #ay1.text(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], word)
                    #print("Similar words = ",word)        
            else:
                scatter2 = ay1.scatter3D(aresult_X[0, 0], aresult_X[0, 1], aresult_X[0, 2], c='#981826', alpha=0.8, edgecolors='none', marker=(5,1), depthshade=False, s=110)###
                ay1.text(aresult_X[0, 0], aresult_X[0, 1], aresult_X[0, 2], word)
                #print("Target word = ", word)
        return scatter0,scatter1,scatter2
    ...
    def plot_list_dsimwords_tdoc(self,list_dword_id,dresult_X,o):
        for i, word in enumerate(list_dword_id):
            if i != 0:
                if i < o:
                    scatter0 = ax2.scatter3D(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], c='#007d92', alpha=0.8, edgecolors='none', marker='>', depthshade=False, s=80)###
                    ax2.text(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], word)
                    #print("Similar words = ",word)
                else:
                    scatter1 = ax2.scatter3D(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], c='#fdd03b', alpha=0.5, edgecolors='none', marker='>', depthshade=False, s=80)###
                    #ax2.text(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], word)
                    #print("Similar words = ",word)        
            else:
                scatter2 = ax2.scatter3D(dresult_X[0, 0], dresult_X[0, 1], dresult_X[0, 2], c='#981826', alpha=0.8, edgecolors='none', marker=(5,1), depthshade=False, s=110)###
                ax2.text(dresult_X[0, 0], dresult_X[0, 1], dresult_X[0, 2], word)
                #print("Target word = ", word)
        return scatter0,scatter1,scatter2
    ...
    def plot_list_asimwords_tdoc(self,list_aword_id,aresult_X,o):
        for i, word in enumerate(list_aword_id):
            if i != 0:
                if i < o:
                    scatter0 = ay2.scatter3D(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], c='#4a9396', alpha=0.8, edgecolors='none', marker='>', depthshade=False, s=80)###
                    ay2.text(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], word)
                    #print("Similar words = ",word)
                else:
                    scatter1 = ay2.scatter3D(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], c='#fdd03b', alpha=0.5, edgecolors='none', marker='>', depthshade=False, s=80)###
                    #ay2.text(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], word)
                    #print("Similar words = ",word)        
            else:
                scatter2 = ay2.scatter3D(aresult_X[0, 0], aresult_X[0, 1], aresult_X[0, 2], c='#981826', alpha=0.8, edgecolors='none', marker=(5,1), depthshade=False, s=110)###
                ay2.text(aresult_X[0, 0], aresult_X[0, 1], aresult_X[0, 2], word)
                #print("Target word = ", word)
        return scatter0,scatter1,scatter2
    ...
    def plot_list_dsimwords_feat(self,list_dword_id,dresult_X,o):
        for i, word in enumerate(list_dword_id):
            if i != 0:
                if i < o:
                    scatter0 = ax3.scatter3D(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], c='#4a9396', alpha=0.8, edgecolors='none', marker='>', depthshade=False, s=80)###
                    ax3.text(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], word)
                    #print("Similar words = ",word)
                else:
                    scatter1 = ax3.scatter3D(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], c='#fdd03b', alpha=0.5, edgecolors='none', marker='>', depthshade=False, s=80)###
                    #ax3.text(dresult_X[i, 0], dresult_X[i, 1], dresult_X[i, 2], word)
                    #print("Similar words = ",word)        
            else:
                scatter2 = ax3.scatter3D(dresult_X[0, 0], dresult_X[0, 1], dresult_X[0, 2], c='#981826', alpha=0.8, edgecolors='none', marker=(5,1), depthshade=False, s=110)###
                ax3.text(dresult_X[0, 0], dresult_X[0, 1], dresult_X[0, 2], word)
                #print("Target word = ", word)
        return scatter0,scatter1,scatter2
    ...
    def plot_list_asimwords_feat(self,list_aword_id,aresult_X,o):
        for i, word in enumerate(list_aword_id):
            if i != 0:
                if i < o:
                    scatter0 = ay3.scatter3D(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], c='#4a9396', alpha=0.8, edgecolors='none', marker='>', depthshade=False, s=80)###
                    ay3.text(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], word)
                    #print("Similar words = ",word)
                else:
                    scatter1 = ay3.scatter3D(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], c='#fdd03b', alpha=0.5, edgecolors='none', marker='>', depthshade=False, s=80)###
                    #ax3.text(aresult_X[i, 0], aresult_X[i, 1], aresult_X[i, 2], word)
                    #print("Similar words = ",word)        
            else:
                scatter2 = ay3.scatter3D(aresult_X[0, 0], aresult_X[0, 1], aresult_X[0, 2], c='#981826', alpha=0.8, edgecolors='none', marker=(5,1), depthshade=False, s=110)###
                ay3.text(aresult_X[0, 0], aresult_X[0, 1], aresult_X[0, 2], word)
                #print("Target word = ", word)
        return scatter0,scatter1,scatter2
        ...
        for j, doc in enumerate(list_ddoc_id):
            if j != 0 and j != 1:
                ...
                if j < p:
                    if dz:
                        #print("addsim_adocs = ", z.groups())
                        scatter0 = ax4.scatter3D(dresult_X[j, 0], dresult_X[j, 1], dresult_X[j, 2], c='#4a9396', alpha=0.8, edgecolors='none', marker='o', depthshade=False, s=80)###
                        ax4.text(dresult_X[j, 0], dresult_X[j, 1], dresult_X[j, 2], doc)
                        print("Top 10 Similar articles = ", doc)
                    else:
                        #print("subsim_adocs = ", z.groups())
                        scatter1 = ax4.scatter3D(dresult_X[j, 0], dresult_X[j, 1], dresult_X[j, 2], c='#fdd03b', alpha=0.8, edgecolors='none', marker='o', depthshade=False, s=80)###
                        ax4.text(dresult_X[j, 0], dresult_X[j, 1], dresult_X[j, 2], doc)
                        print("Similar articles = ", doc)
            elif j == 1:
                scatter2 = ax4.scatter3D(dresult_X[1, 0], dresult_X[1, 1], dresult_X[1, 2], c='#f3166b', alpha=0.8, edgecolors='none', marker=(5,0), depthshade=False, s=110)###
                ax4.text(dresult_X[1, 0], dresult_X[1, 1], dresult_X[1, 2], doc)
                #print("Target word = ", doc)
            elif j == 0:
                scatter3 = ax4.scatter3D(dresult_X[0, 0], dresult_X[0, 1], dresult_X[0, 2], c='#981826', alpha=0.8, edgecolors='none', marker=(5,1), depthshade=False, s=110)###
                ax4.text(dresult_X[0, 0], dresult_X[0, 1], dresult_X[0, 2], doc)
        ...
        for j, doc in enumerate(list_adoc_id):
            if j != 0 and j != 1:
                ...
                if j < p:
                    if az:
                        #print("addsim_adocs = ", z.groups())
                        scatter0 = ay4.scatter3D(aresult_X[j, 0], aresult_X[j, 1], aresult_X[j, 2], c='#4a9396', alpha=0.8, edgecolors='none', marker='o', depthshade=False, s=80)###
                        ay4.text(aresult_X[j, 0], aresult_X[j, 1], aresult_X[j, 2], doc)
                        print("Top 10 Similar articles = ", doc)
                    else:
                        #print("subsim_adocs = ", z.groups())
                        scatter1 = ay4.scatter3D(aresult_X[j, 0], aresult_X[j, 1], aresult_X[j, 2], c='#fdd03b', alpha=0.8, edgecolors='none', marker='o', depthshade=False, s=80)###
                        ay4.text(aresult_X[j, 0], aresult_X[j, 1], aresult_X[j, 2], doc)
                        print("Similar articles = ", doc)
            elif j == 1:
                scatter2 = ay4.scatter3D(aresult_X[1, 0], aresult_X[1, 1], aresult_X[1, 2], c='#f3166b', alpha=0.8, edgecolors='none', marker=(5,0), depthshade=False, s=110)###
                ay4.text(aresult_X[1, 0], aresult_X[1, 1], aresult_X[1, 2], doc)
                #print("Target word = ", doc)
            elif j == 0:
                scatter3 = ay4.scatter3D(aresult_X[0, 0], aresult_X[0, 1], aresult_X[0, 2], c='#981826', alpha=0.8, edgecolors='none', marker=(5,1), depthshade=False, s=110)###
                ay4.text(aresult_X[0, 0], aresult_X[0, 1], aresult_X[0, 2], doc)
                #print("Feature vector = ", doc)
        return scatter0,scatter1,scatter2,scatter3
...
if __name__ == '__main__':
    ...
    ax1.set_zticklabels([]) #Hide ticks
    ax1.text2D(0.25, 0.95, '[3D] Similar words - Target Word Vector with Deepcut (n_similar words = ' + str(o) + ' , target word = ' + target_word + ')', transform=ax1.transAxes)
    plot_list_dvec = vec_model.plot_list_dsimwords_tword(list_dwords_sim_id,dresult_X_tword,o) 
    
    legend1 = ax1.legend((plot_list_dvec[0],plot_list_dvec[1],plot_list_dvec[2]), ('Top 10 Similar Words','Similar Words','Target Word'), scatterpoints=1, labelspacing=1, title=docs_vec, loc='center left', bbox_to_anchor=(0.85,0.63))
    ...
    ay1.set_zticklabels([]) #Hide ticks
    ay1.text2D(0.25, 0.95, '[3D] Similar words - Target Word Vector with Attacut (n_similar words = ' + str(o) + ' , target word = ' + target_word + ')', transform=ay1.transAxes)
    plot_list_avec = vec_model.plot_list_asimwords_tword(list_awords_sim_id,aresult_X_tword,o) 
    
    legend1 = ay1.legend((plot_list_avec[0],plot_list_avec[1],plot_list_avec[2]), ('Top 10 Similar Words','Similar Words','Target Word'), scatterpoints=1, labelspacing=1, title=docs_vec, loc='center left', bbox_to_anchor=(0.85,0.63))
    ...
    ax2.set_zticklabels([]) #Hide ticks
    ax2.text2D(0.25, 0.95, '[3D] Similar words - Target Paragraph Vector with Deepcut (n_similar words = ' + str(o) + ' , target article = ' + target_doc + ')', transform=ax2.transAxes)
    plot_list_dvec2 = vec_model.plot_list_dsimwords_tdoc(list_dwords_sim_id2_tdoc,dresult_X_tdoc,o) 
    
    legend1 = ax2.legend((plot_list_dvec2[0],plot_list_dvec2[1],plot_list_dvec2[2]), ('Top 10 Similar Words','Similar Words','Target Article'), scatterpoints=1, labelspacing=1, title=docs_vec, loc='center left', bbox_to_anchor=(0.85,0.63))
    ...
    ay2.set_zticklabels([]) #Hide ticks
    ay2.text2D(0.25, 0.95, '[3D] Similar words - Target Paragraph Vector with Attacut (n_similar words = ' + str(o) + ' , target article = ' + target_doc + ')', transform=ay2.transAxes)
    plot_list_avec2 = vec_model.plot_list_asimwords_tdoc(list_awords_sim_id2_tdoc,aresult_X_tdoc,o) 
    
    legend1 = ay2.legend((plot_list_avec2[0],plot_list_avec2[1],plot_list_avec2[2]), ('Top 10 Similar Words','Similar Words','Target Article'), scatterpoints=1, labelspacing=1, title=docs_vec, loc='center left', bbox_to_anchor=(0.85,0.63))
    ...
    ax3.set_zticklabels([]) #Hide ticks
    ax3.text2D(0.25, 0.95, '[3D] Similar words - Feature Vector with Deepcut (n_similar words = ' + str(o) + ' , target article = ' + target_doc + ')', transform=ax3.transAxes)
    plot_list_dvec3 = vec_model.plot_list_dsimwords_feat(list_dwords_sim_id3_feat,dresult_X_feat,o) 
    
    legend1 = ax3.legend((plot_list_dvec3[0],plot_list_dvec3[1],plot_list_dvec3[2]), ('Top 10 Similar Words','Similar Words','Target Article'), scatterpoints=1, labelspacing=1, title=docs_vec, loc='center left', bbox_to_anchor=(0.85,0.63))
    ...
    ay3.set_zticklabels([]) #Hide ticks
    ay3.text2D(0.25, 0.95, '[3D] Similar words - Feature Vector with Attacut (n_similar words = ' + str(o) + ' , target article = ' + target_doc + ')', transform=ay3.transAxes)
    plot_list_avec3 = vec_model.plot_list_asimwords_feat(list_awords_sim_id3_feat,aresult_X_feat,o) 
    
    legend1 = ay3.legend((plot_list_avec3[0],plot_list_avec3[1],plot_list_avec3[2]), ('Top 10 Similar Words','Similar Words','Target Article'), scatterpoints=1, labelspacing=1, title=docs_vec, loc='center left', bbox_to_anchor=(0.85,0.63))
    ...
    ax4.set_zticklabels([]) #Hide ticks
    ax4.text2D(0.25, 0.95, '[3D] Similar words - Feature Vector with Deepcut (n_similar articles = ' + str(p) + ' , target article = ' + target_doc + ')', transform=ax4.transAxes)
    plot_list_dvec4 = vec_model.plot_list_dsimdocs_feat(list_ddocs_sim_id4_feat,dresult_X_feat_pv,p,patterns2) 
    
    legend1 = ax4.legend((plot_list_dvec4[0],plot_list_dvec4[1],plot_list_dvec4[2],plot_list_dvec4[3]), ('Similar Articles (same genre of news)','Similar Articles (other genre of news)','Target Article','Feature vector'), scatterpoints=1, labelspacing=1, title=docs_vec, loc='center left', bbox_to_anchor=(0.85,0.63))
    ...
    ay4.set_zticklabels([]) #Hide ticks
    ay4.text2D(0.25, 0.95, '[3D] Similar words - Feature Vector with Attacut (n_similar articles = ' + str(p) + ' , target article = ' + target_doc + ')', transform=ay4.transAxes)
    plot_list_avec4 = vec_model.plot_list_asimdocs_feat(list_adocs_sim_id4_feat,aresult_X_feat_pv,p,patterns2) 
    
    legend1 = ay4.legend((plot_list_avec4[0],plot_list_avec4[1],plot_list_avec4[2],plot_list_avec4[3]), ('Similar Articles (same genre of news)','Similar Articles (other genre of news)','Target Article','Feature vector'), scatterpoints=1, labelspacing=1, title=docs_vec, loc='center left', bbox_to_anchor=(0.85,0.63))

# -*- coding: utf-8 -*-
"""
Created on Sun Jun  7 13:25:36 2020
...
class doc_labeling(object):
    ...
    def doc_to_vec(self,documents):
        ...
        %time model.save('model_attacut_test2')  #*** 14,880 articles


if __name__ == '__main__':
        
    doclb = doc_labeling()
    a = doclb.get_body_eco(50) #*** 2480 articles
    b = doclb.get_body_edu(50) #*** 2480 articles
    c = doclb.get_body_ent(50) #*** 2480 articles
    d = doclb.get_body_fore(50) #*** 2480 articles
    e = doclb.get_body_it(50) #*** 2480 articles
    f = doclb.get_body_spo(50) #*** 2480 articles
    ...
    print(all_list_vec)
    with open('json_all_list_vec_attacut_test2.txt','w', encoding='utf-8') as f:
